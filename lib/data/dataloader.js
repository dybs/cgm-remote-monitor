...
var ONE_DAY = 86400000
  , TWO_DAYS = 172800000
  /*
    BD - Try three days instead for testing.
  */
  , THREE_DAYS = 172800000;
...
function loadEntries (ddata, ctx, callback) {
  var dateRange = {
    ...
    /*
      BD - Try three days instead for testing.
      If this works, add a setting for dateRange
    */
    $gte: ddata.lastUpdated - THREE_DAYS
  };
...
function mergeToTreatments (ddata, results) {
  ...
  /*
    BD - Try three days instead for testing.
    If this works, add a setting for oldestAgo
  */
  var oldestAgo = ddata.lastUpdated - THREE_DAYS - times.hour().msecs;
