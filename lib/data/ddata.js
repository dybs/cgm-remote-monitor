...
function init () {
  ...
  ddata.processTreatments = function processTreatments (preserveOrignalTreatments) {
    ...
    // filter & prepare 'Follicular Phase' events
    ddata.follicularPhaseTreatments = ddata.treatments.filter( function filterFollicularPhase (t) {
      return t.eventType.indexOf('Follicular Phase') > -1;
