...
function init(ctx) {
  ...
  cage.findLatestTimeChange = function findLatestTimeChange (sbx) {
    ...
    var prevDate = 0;
    console.log("CAGE Start treatment search");
    _.each(sbx.data.sitechangeTreatments, function eachTreatment (treatment) {
      var treatmentDate = treatment.mills;
      console.log("CAGE prevDate: ", prevDate, ", Treatement date: ", treatmentDate, ", sbxTime: ", sbx.time);
      if (treatmentDate > prevDate && treatmentDate <= sbx.time) {
        console.log("CAGE Treatment w/in date range");
        ...
        console.log("CAGE Treatment age: ", age, ", cannulaInfoAge: ", cannulaInfo.age);
        if (!cannulaInfo.found || (age >= 0 && age < cannulaInfo.age)) {
          console.log("CAGE Treatment found");
      ...
      console.log("CAGE End treatment search");
    });
    ...
    console.log("CAGE found=", cannulaInfo.found, 
                ", age=", cannulaInfo.age,
                ", days=", cannulaInfo.days, 
                ", hrs=", cannulaInfo.hours, 
                ", date=", cannulaInfo.treatmentDate, 
                ", notes=", cannulaInfo.notes, 
                ", prefsDisplay=", prefs.display);
